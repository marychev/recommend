...
async def list_tracks(
    genre: Optional[str] = Query(None, description="Фильтр по жанру", examples=["Rock"]),
    artist: Optional[str] = Query(None, description="Фильтр по исполнителю", examples=["Queen"]),
