...
• Всего запросов:            1230   | 1250   | 1300   | 1255 
• Общий процент ошибок:      60.00% | 59.76% | 59.76% | 59.77%        
...
🎯 GET /recommendations (HEAVY):
   Среднее: 56ms | p95: 128ms | Max: 343ms
...
📊 Статистика:                                 
   Всего запросов:                                 84                    
   Среднее время ответа:  [24.29ms, 37.53ms, 107.00ms]   | 29.81ms    | 28.69     |   
   95 перцентиль:         [59.86ms, 107.00ms]            | 64.46ms    | 84.120ms  | 84.20ms 
   Процент ошибок:        0.00%     
...
# [ERROR] k6 run load_tests/k6_recommendations_performance_test.js - LONG
...
• Похожих пользователей (среднее): 15.3   || 12.3   || 16.8   
• Похожих пользователей (мин):     12     || 11     || 9     || 6
• Похожих пользователей (макс):    12     || 14     || 28    || 14
