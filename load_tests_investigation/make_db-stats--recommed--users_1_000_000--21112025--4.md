> PYTESTS 126 passed, 12 skipped, 11 warnings in 39.76s
...
📋 GET /users (list):     
   Среднее: 75ms | p95: 196ms | Max: 254ms
...
🎵 GET /tracks (list):      
   Среднее: 85ms | p95: 232ms | Max: 338ms  
...
• Похожих пользователей (среднее): 15.0 || 15.3   || 12.3   || 16.8   
• Похожих пользователей (мин):     13   || 12  || 11     || 9     || 6
• Похожих пользователей (макс):    18   || 12  || 14     || 28    || 14

⏱️  ОБЩЕЕ ВРЕМЯ ОТВЕТА:                       
Total Response Time:     
   avg: 660.33ms | med: 627.88ms | p95: 1088.77ms | p99: 0.00ms  source=console
