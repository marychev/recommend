...
Kafka UI - мощный веб-интерфейс для мониторинга и управления Apache Kafka.
...
✨ **Основные функции:**
- 📊 **Просмотр топиков** - все топики, партиции, размер
- 📨 **Просмотр сообщений** - содержимое событий в реальном времени
- 👥 **Consumer Groups** - статус, lag, offset потребителей
- 🔍 **Поиск по сообщениям** - фильтрация и поиск событий
- 📈 **Метрики брокеров** - производительность Kafka кластера
- ⚙️ **Управление конфигурацией** - настройки топиков и кластера
...
3. Найдите топик **"user_track_events"**
4. Нажмите **"Messages"** для просмотра событий в реальном времени
5. Выберите партицию и offset для навигации
...
Причина: Kafka еще не запущена или топик не создан
